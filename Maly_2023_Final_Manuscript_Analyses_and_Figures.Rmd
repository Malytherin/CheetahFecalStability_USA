---
title: "Aju_USA_Analyses_Final.Figures"
author: "M. Maly"
date: "2022-08-02"
...
# PD ANOVA Model
PDs8_aov <- aov(PD ~ FecalSeries + SampleDay + MaxDailyCR, data = dfS8)
summary(PDs8_aov)
...
bray_adonis <- adonis2(bray_S8 ~ SampleDay + FecalSeries + MaxDailyCR, data = dfS8, by = "margin")
bray_adonis

bray_adonis5 <- adonis2(bray_S8 ~ SampleDay + FecalSeries, data = dfS8)
bray_adonis5

bray_adonis5 <- adonis2(bray_S8 ~ MaxDailyCR + FecalSeries, data = dfS8, by = "margin")
bray_adonis5

bray_adonis3 <- adonis2(bray_S8 ~ MaxDailyCR + SampleDay + FecalSeries , data = dfS8)

bray_adonis4 <- adonis2(bray_S8 ~ MaxDailyCR + SampleDay + FecalSeries , data = dfS8, by = "margin")
...
```{r}
Figure3 <- S8Bray2 + S8Bray3 + plot_layout(nrow = 1)

#ggsave("/Users/morganmaly/OneDrive - Smithsonian Institution/Cheetah Poop Time Studies/Cheetah_GMB_PT_Manuscript/CGMB_SCBI.PT_Manuscript/HostAndMicrobiota/Reviewed_Figures/HaM_Figure3.pdf", Figure3, dpi = 350, width = 10)
```

Figure S3 - Distance to centroids for all three beta measures
```{r}
FigS3 <- BCbxp + JCbxp + UUbxp + plot_layout(nrow = 3)

ggsave("/Users/morganmaly/OneDrive - Smithsonian Institution/Cheetah Poop Time Studies/Cheetah_GMB_PT_Manuscript/CGMB_SCBI.PT_Manuscript/HostAndMicrobiota/Supplemental Tables and Figures/HaM_Supplemental Figure_3.pdf", FigS3, dpi = 350, width = 10, height = 8)
```
...
# Make network plot
Network <- plot_network(igB, S8, color = "SampleDay", line_weight = 0.5, label = "FecalSeries", shape = "FecalSeries") + 
  scale_color_manual(values =  col6) + 
  scale_shape_manual(values = c(15,16,17,18,0,1,24,25)) + 
  theme(text = element_text(size = 15)) +
  labs(shape = "Fecal ID", color = "Sample Day")

#ggsave("/Users/morganmaly/OneDrive - Smithsonian Institution/Cheetah Poop Time Studies/Cheetah_GMB_PT_Manuscript/CGMB_SCBI.PT_Manuscript/HostAndMicrobiota/Reviewed_Figures/HaM_Figure4.pdf", Network, dpi = 350, width = 8)
