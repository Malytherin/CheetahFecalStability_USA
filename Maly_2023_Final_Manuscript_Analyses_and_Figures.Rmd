...
S8_P_tukeyASVs <- c("ASV4", "ASV1", "ASV2", "ASV17") # From DA test results
sigP <- S8_P_tukeyASVs
sigP
...
# Remove phyla that were NOT significantly different across days
select_sigPhyla <- subset_taxa(s8.P.RA, Phylum != "Candidatus_Saccharibacteria")
select_sigPhyla <- subset_taxa(select_sigPhyla, Phylum != "Actinobacteria")
...
select_sigASVs <- subset_taxa(s8RA, ASV %in% sigASVs)

# Set as factors
select_sigASVs@sam_data$Fecal.ID <- c("Aju 1", "Aju 1", "Aju 1","Aju 1","Aju 1","Aju 1", "Aju 2", "Aju 2", "Aju 2", "Aju 2", "Aju 2", "Aju 2", "Aju 3", "Aju 3", "Aju 3", "Aju 3", "Aju 3", "Aju 4", "Aju 4", "Aju 4", "Aju 4", "Aju 4", "Aju 4", "Aju 5", "Aju 5", "Aju 5", "Aju 5", "Aju 5", "Aju 6", "Aju 6", "Aju 6", "Aju 6", "Aju 6", "Aju 6", "Aju 7", "Aju 7", "Aju 7", "Aju 7", "Aju 8", "Aju 8", "Aju 8")
select_sigASVs@sam_data$Fecal_Series <- select_sigASVs@sam_data$Fecal.ID
sample_data(select_sigASVs)$SampleDay <- factor(sample_data(select_sigASVs)$SampleDay, levels = c("Day 0", "Day 1", "Day 2", "Day 3", "Day 4", "Day 5"))

# Group by Sample Day 
ph.Fid <- plot_heatmap(select_sigASVs, distance = "euclidean", sample.label = "Fecal_Series", taxa.label = "ASV", taxa.order = "Genus", high = "red", low = "yellow", na.value = "darkgrey", sample.order = "Fecal.ID") + theme(text = element_text(family = "Times New Roman"))
